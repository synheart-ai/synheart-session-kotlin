...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-session-kotlin/security/advisories/new).
...
This policy covers the `synheart-session` Kotlin/Android SDK published from
this repository. Issues in unrelated dependencies should be reported upstream
